...
import {uploadFile} from "./ImportHouseReadingsActions";
import {Alert, Button} from "reactstrap";
import {connect} from "react-redux";
import {confirmAlert} from "react-confirm-alert";
import 'react-confirm-alert/src/react-confirm-alert.css'

class HouseReadingsDropzone extends Component {
  constructor(props) {
    super(props);
    this.state = {file: {}};
          ...
          {({getRootProps, getInputProps, isDragActive, isDragReject, rejectedFiles, acceptedFiles}) => {
            ...
            return (
              <div {...getRootProps()}>
                ...
                <div className="help-block"><Alert color="white">{this.props.importHouseReadingsResults}</Alert></div>
              </div>
...
const mapStateToProps = (state) => {
  return {
    ...
    error: state.ReducersHouseReadings.error,
    importHouseReadingsResults: state.ReducersHouseReadings.importHouseReadingsResults,
  }
};
